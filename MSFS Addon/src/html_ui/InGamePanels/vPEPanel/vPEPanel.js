(function () {
    ...
    class LoadingIcon extends DisplayComponent {
        render() {
            return (FSComponent.buildComponent("div", { id: "loading-icon" },
                FSComponent.buildComponent("icon-stack", { created: "true", "data-input-group": "ICON-STACK" },
                    FSComponent.buildComponent("icon-element", { "data-url": "/icons/ICON_LOADING.svg" }))));
        }
    }
    ...
    class AwaitingConnection extends DisplayComponent {
        ...
        render() {
            return (FSComponent.buildComponent("div", { class: 'awaiting-connection', ref: this.mainRef },
                FSComponent.buildComponent("div", { class: "awaiting-connection-inner" },
                    FSComponent.buildComponent(LoadingIcon, null),
                    FSComponent.buildComponent("p", { class: "pt-3" }, "Awaiting vPilot Connection..."),
                    FSComponent.buildComponent("p", { class: "pt-2 text-base font-light" }, this.props.timeToRetry.map((time) => {
    ...
    class ConnectPage extends DisplayComponent {
        constructor(props) {
            ...
            this.aircraft = "";
            this.selcal = "";
            this.errors = Subject.create({
                callsign: [inputErrors.callsign.tooShort],
                aircraft: [],
                selcal: []
            });
            this.pageRef = FSComponent.createRef();
            this.errorRef = FSComponent.createRef();
            this.callsignRef = FSComponent.createRef();
            this.aircraftRef = FSComponent.createRef();
            this.selcalRef = FSComponent.createRef();
            this.connectRef = FSComponent.createRef();
        }
        hide() {
        ...
        render() {
            return (FSComponent.buildComponent("div", { class: "hidden mx-2 pt-2", ref: this.pageRef },
                FSComponent.buildComponent("div", { class: "grid grid-cols-1 justify-items-center pb-2" },
                    FSComponent.buildComponent("span", { class: "font-bold" }, "Connect to network")),
                FSComponent.buildComponent("hr", { class: "pb-1" }),
                FSComponent.buildComponent("div", { ref: this.errorRef, class: "hidden error-bg w-100 h-auto px-2 py-1 rounded-md mb-2" },
                    FSComponent.buildComponent("span", { class: "text-base font-bold" }, "Error"),
                ...
                FSComponent.buildComponent("new-push-button", { ref: this.connectRef, class: "w-auto mt-4 mx-4 text-center", title: "Connect" })));
        }
    }

    class InputBox extends DisplayComponent {
        constructor(props) {
            super(props);
            this.ref = FSComponent.createRef();
        ...
        render() {
            return (FSComponent.buildComponent("textarea", { rows: "3", cols: "33", ref: this.ref, class: `default-textarea ${this.props.class}`, id: this.props.id, type: "text", "no-tooltip": true, "no-key-navigation": true, "not-pad-interactive": true, idevent: "0" }));
        }
    }

    class ScrollButton extends DisplayComponent {
        constructor(props) {
            super(props);
            this.ref = FSComponent.createRef();
        }
    ...
    document.addEventListener("DOMContentLoaded", () => {
        FSComponent.render(FSComponent.buildComponent(VPEPanel, null), document.getElementById("vPEPanel"));
    });
    checkAutoload();
