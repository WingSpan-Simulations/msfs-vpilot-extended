import {
    ComponentProps, DisplayComponent, EventBus, Fragment, FSComponent, NodeReference, Publisher,
    Subject, VNode
...
export interface ConnectPage {
    ...
    connectRef: NodeReference<HTMLElement>
}
export class ConnectPage extends DisplayComponent<ConnectProps> {
    ...
    private readonly aircraftSetting = new AircraftSaveManager(this.props.bus)
    ...
    constructor(props: ConnectProps) {
        ...
        this.callsignRef = FSComponent.createRef<InputBar>();
        this.aircraftRef = FSComponent.createRef<InputBar>();
        this.selcalRef = FSComponent.createRef<InputBar>();
        this.connectRef = FSComponent.createRef<HTMLElement>();
    }
        ...
        return (
            <div class="hidden mx-2 pt-2" ref={this.pageRef}>
                ...
                <div class="grid grid-cols-4 mt-4">
                    ...
                    <InputBar ref={this.callsignRef} requireInput={true} onInput={this.onCallsignInput.bind(this)} transformInput={(input) => { return this.transformInput(input, 7, alphanumericRegex) }} id="callsign" class="col-span-2" />
                </div>
                <div class="grid grid-cols-4 mt-2">
                    <p class="col-span-2 font-semibold">Aircraft Code</p>
                    <InputBar ref={this.aircraftRef} requireInput={true} onInput={this.onAircraftInput.bind(this)} transformInput={(input) => { return this.transformInput(input, 4, alphanumericRegex) }} id="aircraftCode" class="col-span-2" />
                </div>
                <div class="grid grid-cols-4 mt-2">
